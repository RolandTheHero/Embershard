...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        OptionData bnUserOptions = new OptionData(OptionType.STRING, "bn-user", "The Battle Nations username of the member to view the policy of.", false, true);
